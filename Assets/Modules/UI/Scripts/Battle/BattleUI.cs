...
namespace UI.Battle
{
	...
	public class BattleUI : MonoBehaviour
	{
		...
		public IEnumerator StartEnemyTurn(PlayerInformation playerInformation)
		{
			...
			{
				StartCoroutine(battleOptionsGroup.Fade(4,
					0.1f,
					1f,
					0f)),
				StartCoroutine(battleEnemiesGroup.Fade(4,
					0.1f,
					1f,
					0.5f))
			};
			...
			yield return minigameManager.Appear();
		}

		public IEnumerator EndEnemyTurn(PlayerInformation playerInformation)
		{
			yield return minigameManager.Disappear();
